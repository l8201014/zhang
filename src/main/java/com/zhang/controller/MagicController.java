...
import com.zhang.reptile.ReptileMagicImpl;
...
public class MagicController {
    ...
    public String queryMagnetic (HttpServletRequest request){
        ...
        List<Rresource> resourcesList = reptileMagic.getList(keyWord,pageIndex);
...
//            pageConfig.setTotalCount(reptileMagic.getTotalNum(keyWord));
//        }
    ...
    public String queryMagnetic1 (HttpServletRequest request){
        ...
        logger.info(keyWord);
        long start = System.currentTimeMillis();
        List<Rresource> resourcesList = reptileMagic.getListNew(keyWord);
        long end = System.currentTimeMillis();
    ...
    public String queryMagneticDetails (HttpServletRequest request){
        ...
        logger.info("详情id" + id);
        long start = System.currentTimeMillis();
        Rresource resource = reptileMagic.getDetails(id);
        long end = System.currentTimeMillis();
    ...
    public String queryMagneticDetails1 (HttpServletRequest request){
        ...
        logger.info(listUrl);
        long start = System.currentTimeMillis();
        Rresource resource = reptileMagic.getDetailsNew(listUrl);
        long end = System.currentTimeMillis();
